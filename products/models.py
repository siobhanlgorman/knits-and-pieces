...
class Product(models.Model):
    ...
    colour2 = models.CharField(max_length=50, blank=True, default="")
    colour3 = models.CharField(max_length=50, blank=True, default="")
    colour4 = models.CharField(max_length=50, blank=True, default="")
